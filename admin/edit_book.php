<?php
    ...
    $B_No = $_REQUEST['bn'];
    $Edit_Select = "SELECT `bid`, `bname`, `authid`, `catname`,`bookno`,`bookprice` FROM `booktable` WHERE `bookno`='$B_No'";
    $Query = mysqli_query($conn,$Edit_Select);
    ...
    {
        $New_B_Name = $_POST['b_name'];
        $New_Auth_Id = $_POST['auth_id'];
        $New_Cat_N = $_POST['c_name'];
        $New_B_No = $_POST['b_no'];
        $New_B_Price = $_POST['b_price'];
        $Update_Query = "UPDATE `booktable` SET `bname`='$New_B_Name',`authid`='$New_Auth_Id',`catname`='$New_Cat_N',`bookno`='$New_B_No',`bookprice`='$New_B_Price' WHERE `bookno` = '$B_No'";
...
<body>
    ...
    <span>
        <marquee class="bg-dark text-white">This is Liberary Management System. Liberary Opens at 8:00 AM and close at 6:00 PM</marquee>
         ...
         <!-- Books Showed Here , You just Click "Edit" or "Delete" to according to your need. -->
                 ...
                 <div class="col-md-6">
                     <form method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" name="b_name" value="<?php echo $B_name; ?>" class="form-control" aria-describedby="emailHelp" >
                      </div>
                      <div class="form-group">
                        <label for="aid">Author ID</label>
                        <input type="text" name="auth_id" value="<?php echo $Author_id; ?>" class="form-control">
                      </div>
                       <div class="form-group">
                        <label for="aid">Category Name </label>
                        <input type="text" name="c_name" value="<?php echo $Cat_name;  ?>" class="form-control">
                      </div>
                       <div class="form-group">
                        <label for="aid">Book No</label>
                        <input type="text" name="b_no" value="<?php echo $Book_no; ?>" class="form-control">
                      </div>
                       <div class="form-group">
                        <label for="aid">Book Price</label>
                        <input type="text" name="b_price" value="<?php echo $Book_price; ?>" class="form-control">
                      </div>
