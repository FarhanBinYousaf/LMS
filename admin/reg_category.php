        ...
        <div class="col-md-2"></div>
         <div class="col-md-8">
            <div class="alert alert-primary" role="alert">
                 <h5 class="text-center">Registered Categories<span style="color:red;"> (<?php echo get_category_count(); ?>)</span></h5>
                    ...
                    <?php 
                     $Sno= 0;
                      $Cat_Query = "SELECT * FROM `category`";
                        ...
                        while($row = mysqli_fetch_assoc($Cat_Query_run)) 
                        {
