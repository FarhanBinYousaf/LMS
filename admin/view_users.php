        ...
        <div class="col-md-2"></div>
         <div class="col-md-8">
            <div class="alert alert-primary" role="alert">
                 <h5 class="text-center">Registered Users<span style="color:red;"> (<?php echo get_user_count(); ?>)</span></h5>
                     ...
                     $Sno= 0;
                        ...
                        while($row = mysqli_fetch_assoc($Query)) 
                        {
                            ...
                            echo "
                                <tr>
                                    <td>$Sno</td>
                                    <td><strong><span style='color:aqua'>$Name</span></strong></td>
                                    <td>$Email</td>
                                    <td >$mobile</td>
                                    <td>$address</td>
                                </tr>";
