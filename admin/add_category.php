            ...
            <div class="col-md-4"></div>
             <div class="col-md-4">
                <div class="alert alert-info">
                    <h5><strong>Fill the required below information to add New Category</strong></h5>
                </div>
                 <form method="POST">
                    <div class="form-group">
                        <label for="name">Category Name</label>
                         <input type="text" name="name_of_cat" class="form-control"  placeholder="Category Name">
                    </div>
...
<?php 
    if(isset($_POST['add_cat']))
    {
        ...
        $Insert_Cat = "INSERT INTO `category`(`cat_name`) VALUES ('$Category')";
