        ...
        <div class="col-md-2"></div>
         <div class="col-md-8">
            <div class="alert alert-primary" role="alert">
                 <h5 class="text-center">Registered Authors<span style="color:red;"> (<?php echo get_author_count(); ?>)</span></h5>
                    ...
                    <?php 
                     $Sno= 0;
                      $Author_Query = "SELECT * FROM `authors`";
                        $Auth_Query_run  = mysqli_query($conn,$Author_Query);
                        while($row = mysqli_fetch_assoc($Auth_Query_run)) 
                        {
