        ...
        <div class="col-md-2"></div>
         <div class="col-md-8">
            <div class="alert alert-primary" role="alert">
                 <h5 class="text-center">Issued Books<span style="color:red;"> (<?php echo get_issued_book_count(); ?>)</span></h5>
            ...
            <table class="table table-striped table-dark">
              ...
              <tbody>
                    ...
                    <?php 
                     $Sno= 0;
                      $Issued_Query = "SELECT issued_books.book_name,issued_books.book_no,issued_books.book_author,lms_table.name FROM `issued_books` left join `lms_table` ON issued_books.student_id = lms_table.ID";
                        $Book_Query  = mysqli_query($conn,$Issued_Query); 
