<?php
    ...
    $AI = $_REQUEST['ai'];
    $AuthorSelect = "SELECT `author_name` FROM `authors` WHERE `author_id`='$AI'";
    $Query = mysqli_query($conn,$AuthorSelect);
    ...
    {
        $NewAuthName = $_POST['Ncat'];
        $UpdateQuery = "UPDATE `authors` SET `author_name`='$NewAuthName' WHERE `author_id` = '$AI'";
                 ...
                 <div class="col-md-6">
                     <form method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" name="Ncat" value="<?php echo $AName; ?>" class="form-control" aria-describedby="emailHelp" >
                      </div>
