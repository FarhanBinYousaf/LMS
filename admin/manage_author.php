            ...
            <div class="col-md-2"></div>
             <div class="col-md-8">
                <div class="alert alert-primary">
                    <h5 class="text-center">Here are the <strong>Registered Book's Author</strong> you just have to choose action.</h5>
                </div>
                <table class="table table-striped table-dark">
                      ...
                      <tbody>
                        <?php 
                            ...
                            $AuthorSelect = "SELECT * FROM `authors`";
                            $QueryResult = mysqli_query($conn,$AuthorSelect);
                                ...
                                $AuthName = $Row['author_name'];
                                 ...
                                 ?>
                                    <tr>
                                      ...
                                      <td><a href="edit_auth.php?ai=<?php echo $AuthID; ?>" class="btn btn-primary">Edit</a> <a href="delete_auth.php?ioa=<?php echo $AuthID; ?>" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php 
                            }
