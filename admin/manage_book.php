            ...
            <div class="col-md-2"></div>
             <div class="col-md-8">
                <div class="alert alert-primary">
                    <h5 class="text-center">Here are the <strong>Registered Books</strong> you just have to choose action.</h5>
                </div>
                <table class="table table-striped table-dark">
                      ...
                      <tbody>
                        <?php 
                            $S_No = 0;
                            $Book_Select = "SELECT * FROM `booktable`";
                            $Query_result = mysqli_query($conn,$Book_Select);
                                ...
                                $S_No++;
                                 ?>
                                    <tr>
                                      ...
                                      <td><a href="edit_book.php?bn=<?php echo $Book_No; ?>" class="btn btn-primary">Edit</a> <a href="delete_book.php?nb=<?php echo $Book_No; ?>" class="btn btn-primary">Delete</a></td>
                                    </tr>
                                    <?php 
                            }
