            ...
            <div class="col-md-4"></div>
             <div class="col-md-4">
                <div class="alert alert-danger" style="color:black">
                    <h5><strong>Fill the Information below to add New Book</strong></h5>
                </div>
                 <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="aid">
                            ...
                            while ($Fetch_Author = mysqli_fetch_assoc($Query_run)) {
                              $Author_id = $Fetch_Author['author_id'];
                              ?>
                              <option><?php echo $Author_id; ?></option>
                              <?php 
                            }
                        ?>
                        </select>
                    ...
                    <div class="form-group">
                        <label for="name">Book No</label>
                         <input type="text" name="bno" class="form-control"  placeholder="Book No">
                    </div>
                    <div class="form-group">
                        <label for="name">Book Price</label>
                         <input type="text" name="bprice" class="form-control"  placeholder="Book Price">
                    </div>
...
<?php 
    if(isset($_POST['submit']))
    {
        ...
        $Book = $_POST['bno'];
        $Bookp = $_POST['bprice'];
        $InsertionQuery = "INSERT INTO `booktable` (`bname`,`authid`,`catname`,`bookno`,`bookprice`) VALUES ('$Name','$Author','$Cat','$Book','$Bookp')";
         $myQuery = mysqli_query($conn,$InsertionQuery);
         if($myQuery)
         {
            ?>
