      ...
      <div class="col-md-4">
          <form  class="ml-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mail" value="<?php echo $name; ?>" class="form-control" Disabled>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Email ID</label>
                    <input type="email" name="code" value="<?php echo $Email; ?>" class="form-control" Disabled>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Mobile </label>
                    <input type="text" name="code" value="<?php echo $Mobile;?>" class="form-control" Disabled>
                </div>
                 <div class="form-group">
